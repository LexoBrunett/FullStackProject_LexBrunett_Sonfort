                     ...
                     <div className="col-12 col-md-12 col-lg-4" >
                        <div className="row g-4">
                           <div className="col-6 col-sm-6 col-md-6" style={{marginTop:"16px",padding:"0px 8px"}}>
                              <h6 style={{marginBottom:"16px"}}><b>Clientes</b></h6>
                              <ul className="nav flex-column">
                           ...
                           <div className="col-6 col-sm-6 col-md-6" style={{marginTop:"16px",padding:"0px 8px"}}>
                              <h6 style={{marginBottom:"16px"}}><b>Admin</b></h6>
                              <ul className="nav flex-column">
                     ...
                     <div className="row align-items-center">
                        <div className="col-md-6">
                           <span className="small text-muted">
                              © 2023 Sonfort, Cosplay eCommerce a su domicilio. Todos los derechos reservados.
                           </span>
                        </div>
                        <div className="col-md-6">
