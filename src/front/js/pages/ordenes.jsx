          ...
          <div className="card-body" style={{ padding: "3% 20%" }}>
            ...
            {store.creado ? (
              <div
                ...
                role="alert"
              >
                <strong>¡Orden creada con éxito! </strong>Gracias por tu pedido.
                Estaremos procesando tu orden.
                <button
                  onClick={() => actions.vaciar()}
                  type="button"
                  className="btn-close"
                ...
                <tbody>
                  {store.order.map((item) => (
                    <tr>
                      ...
                      <td>
                        {item.day_Date}/{item.month_Date}/{item.year_Date}
                      </td>
                      <td>$ {item.value}</td>
                    </tr>
                  ))}
